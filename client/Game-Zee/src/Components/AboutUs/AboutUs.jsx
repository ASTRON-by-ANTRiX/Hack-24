...
const About = () => {
  return (
    <div className={styles.aboutContainer}>
      ...
      <div><p className={styles.description}>Space Enthusiasts: With a passion for the mysteries of the universe, we strive to make space science accessible to all.
Educators: We ensure that every rule and concept in the game is backed by solid science, making learning a part of the fun.
Game Designers: We work to balance educational content with engaging mechanics, ensuring the game remains strategic and enjoyable.
